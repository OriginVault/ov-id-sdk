...
interface KeysData {
  generated: string;
  servers: {
    cheqdStudio: ServerConfig;
    ovVaultAgent: ServerConfig;
  };
  shared: {
    signingKey: string;
  };
...
function createEnvFile(keys: DIDCommKeys, outputPath: string): void {
...
function createKeysJson(keys: DIDCommKeys, outputPath: string): void {
...
function displayKeys(keys: DIDCommKeys): void {
