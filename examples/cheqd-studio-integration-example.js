 ...
 */
import { SecurityBridgeService, EnvelopeEncryptionService, SecureKeyStorage, KeyRotationService, SecurityValidationService, SecureDIDCommClient } from '@originvault/ov-id-sdk';
// =============================================================================
...
async function exampleSecureDIDCommMessaging() {
    ...
    const agent = {}; // Replace with actual agent
    ...
    try {
        // Send secure message
        const secureMessage = await secureClient.sendSecureMessage(recipient, 'credential-offer', messageContent, signerDID, password, true // encrypt message
        );
...
export { exampleSecureKeyManagement, exampleEncryptedDataSharing, exampleKeyRotation, exampleSecureDIDCommMessaging, exampleSecurityValidation, exampleErrorHandling };
